 ...
 class SharedPreferencesManager  {
    ...
    companion object {
        ...
        fun getString(key: String, defaultValue: String?): String? {
            return getInstance().sp.getString(key, defaultValue)
        }
        ...
        fun getBoolean(key: String, defaultValue: Boolean): Boolean? {
            return getInstance().sp.getBoolean(key, defaultValue)
        }
        ...
        fun getInt(key: String, defaultValue: Int): Int {
            return getInstance().sp.getInt(key, defaultValue)
        }
        ...
        fun getLong(key: String, defaultValue: Long): Long {
            return getInstance().sp.getLong(key, defaultValue)
        }
        ...
        fun getFloat(key: String, defaultValue: Float): Float {
            return getInstance().sp.getFloat(key, defaultValue)
        }

        fun setString(key: String, value: String) {
            var editor = getInstance().sp.edit()
